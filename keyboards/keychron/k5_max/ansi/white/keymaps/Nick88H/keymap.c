...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [WIN_HALF_QWERTY] = LAYOUT_108_ansi(
        ...
        _______,  _______,  _______,  _______,  _______,  KC_TAB,   KC_CAPS,  KC_A,     KC_S,     KC_D,     KC_F,     KC_G,               _______,                              _______, _______, _______, _______,
        _______,            _______,  _______,  _______,  _______,  KC_APP,   _______,  KC_Z,     KC_X,     KC_C,     KC_V,               _______,           _______,           _______, _______, _______,
        _______,  _______,  _______,                                _______,                                _______,  _______,  _______,  _______, _______,  _______,  _______, _______,          _______, _______),
